            ...
            <div className="portfolio-posit">
                <div className="portfo-card">
                    <Animate scaleX={hovered ? 1.3 : 1} scaleY={hovered ? 1.3 : 1}>
                        <Card onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} data-aos="fade-up" style={{ width: '20rem', height: '14rem', borderRadius: "0.7rem", padding: "0.7rem", marginBottom: "1.7rem" }} className="bg-light text-white">
                            <Card.Img style={{ borderRadius: "0.7rem" }} src={eazyRent} alt="Card image" />
                            <Card.ImgOverlay>
                    ...
                    <Card data-aos="fade-up" style={{ width: '20rem', height: '14rem', borderRadius: "0.7rem", padding: "0.7rem",  marginBottom: "1.7rem" }} className="bg-light text-white">
                        <Card.Img style={{ borderRadius: "0.7rem"}} src={backGroun} alt="Card image" />
                        <Card.ImgOverlay>
